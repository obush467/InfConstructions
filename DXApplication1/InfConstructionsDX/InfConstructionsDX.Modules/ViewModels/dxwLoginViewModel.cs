...
namespace InfConstractionsDX.ViewModels
{
...

    {
        ...
        public void LoadConfig()
        {
            try
            {
                var t = Config.Sections["Config"];
                Config.Config _config = ((Config.Config)Config.Sections["Config"]);
            ...
            catch (Exception e) { MessageService.ShowMessage(e.Message); }
        }
